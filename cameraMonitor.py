...
primary_camera_image = os.path.join(BASE_DIR, 'primary_camera_image_.jpg')
...
class CameraMonitor(object):
    def __init__(self):
        ...
        self._camera = Camera()
        self._camera.primary_camera_image = int(self._parser.get('setting', 'PRIMARY_CAMERA'))
        self._camera.secondary_camera_image = int(self._parser.get('setting', 'SECONDARY_CAMERA'))
